...
test('UEP – Onboard device, complete V&V Overview, then fill UEP', async ({ page }) => {
    ...
    // ── Step 3: Complete V&V Overview (2 rows) ────────────────────────────────
    await vvOverviewComplete(page);
    await page.waitForTimeout(3000);

    // ── Step 4: Complete Usability Evaluation Plan (UEP) ──────────────────────
